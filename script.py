...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"✅ Successfully fetched data for {len(sheets_data)} sheet(s).")
    ...
    for table_name, rows in sheets_data.items():
        ...
        try:
            ...
            print(f"✅ Table '{sanitized_table_name}' is ready.")

        except Exception as e:
            print(f"❌ Error creating/dropping table '{sanitized_table_name}': {e}")
            conn.rollback()
            continue
